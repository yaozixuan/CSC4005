/* Pthread_dynamic Mandelbrot program */
...
int chunk;
pthread_mutex_t mutex; // mutuex lock and unlock next and X_start
...
int main (int argc, char * argv[])
{
    ...
    int rc;
    long p;
    next = Num_Pthreads * chunk;        /* Initialize Next Execution column */
