...
MPI_run_command = "mpiexec -np " + num_workers + " MS_MPI"
...
if(program == "MPI"):
    ...
    MPI_compile_command = "mpicc -o MS_MPI " + MPI_file_name + " -lX11 -lm"
    ...
    Pthread_compile_command = "gcc -o MS_Pthread " + Pthread_file_name + " -lpthread -lX11 -lm"
